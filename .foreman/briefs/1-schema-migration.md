# Phase Brief: 1-schema-migration

**Generated:** 2026-02-12T23:22:57+09:00
**Status:** planned
...
SENQ is an prediction market on Avalanche C-Chain for the Avalanche Build Games hackathon. The initial implementation is complete with:
...
_No dependencies - this is the first phase._

## Phase Spec: 1-schema-migration
...
- ⬜ 2-api-extension (`planned`)
- ⬜ 3-ui-foundation (`planned`)
- ⬜ 4-market-pages (`planned`)
- ⬜ 5-user-features (`planned`)

### Completion

When this phase is complete:
- Run `foreman phase 1-schema-migration done` to mark it as finished
